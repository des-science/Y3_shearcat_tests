...
def parse_args():
    ...
    parser.add_argument('--rhos', default='/home/dfa/sobreira/alsina/Y3_shearcat_tests/alpha-beta-eta-test/measured_correlations/rhos_large_scales.fits',
...
def main():
    ...
    xlim = [1, 6000.]
    ylims = [[1.e-14,5.e-6 ],[1.e-14,1.e-6 ],[3.e-9 ,3.e-4 ],[3.e-12 ,3.e-5 ]]
    rhostitle = ''
